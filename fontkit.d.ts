 ...
 */
export interface OpenTypeFeatures extends TypeFeatures {
  aalt:boolean;
  abvf:boolean;
  abvm:boolean;
  abvs:boolean;
 ...
 */
export interface AATFeatures extends TypeFeatures {
  acnt:boolean;
  ankr:boolean;
  avar:boolean;
  bdat:boolean;
...
export interface Font {
  ...
  availableFeatures: TypeFeatures /** OpenType feature tags (or mapped AAT tags) supported by the font */;
  cff: any;
